...
- [ ] **Изменить SECRET_KEY** - создать `.env` с сильным ключом (минимум 32 символа)
- [ ] **Добавить валидацию SECRET_KEY** - проверка при старте приложения
- [ ] **Базовые тесты аутентификации** - pytest для auth, RBAC, row-level security
- [ ] **Security headers** - HSTS, CSP, X-Frame-Options, X-Content-Type-Options
- [ ] **HTTPS enforcement** - редирект на HTTPS в production
