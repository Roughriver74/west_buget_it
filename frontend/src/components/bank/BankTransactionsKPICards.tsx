        ...
        <Col xs={12} sm={8} lg={4}>
          <Card loading={loading} size="small">
            <Statistic
              ...
              suffix={<Text type="secondary">({kpis.new_percent.toFixed(1)}%)</Text>}
              valueStyle={{ fontSize: 20 }}
            />
            <Progress
              percent={kpis.new_percent}
              showInfo={false}
              strokeColor="#1890ff"
              size="small"
            />
        ...
        <Col xs={12} sm={8} lg={4}>
          <Card loading={loading} size="small">
            <Statistic
              ...
              suffix={<Text type="secondary">({kpis.categorized_percent.toFixed(1)}%)</Text>}
              valueStyle={{ fontSize: 20 }}
            />
            <Progress
              percent={kpis.categorized_percent}
              showInfo={false}
              strokeColor="#52c41a"
              size="small"
            />
        ...
        <Col xs={12} sm={8} lg={4}>
          <Card loading={loading} size="small">
            <Statistic
              ...
              suffix={<Text type="secondary">({kpis.matched_percent.toFixed(1)}%)</Text>}
              valueStyle={{ fontSize: 20 }}
            />
            <Progress
              percent={kpis.matched_percent}
              showInfo={false}
              strokeColor="#722ed1"
              size="small"
            />
        ...
        <Col xs={12} sm={8} lg={4}>
          <Card loading={loading} size="small">
            <Statistic
              ...
              suffix={<Text type="secondary">({kpis.approved_percent.toFixed(1)}%)</Text>}
              valueStyle={{ fontSize: 20 }}
            />
            <Progress
              percent={kpis.approved_percent}
              showInfo={false}
              strokeColor="#389e0d"
              size="small"
            />
        ...
        <Col xs={12} sm={8} lg={4}>
          <Card loading={loading} size="small">
            <Statistic
              ...
              suffix={<Text type="secondary">({kpis.needs_review_percent.toFixed(1)}%)</Text>}
              valueStyle={{ fontSize: 20 }}
            />
            <Progress
              percent={kpis.needs_review_percent}
              showInfo={false}
              strokeColor="#fa8c16"
              size="small"
            />
        ...
        <Col xs={12} sm={8} lg={4}>
          <Card loading={loading} size="small">
            <Statistic
              ...
              suffix={<Text type="secondary">({kpis.ignored_percent.toFixed(1)}%)</Text>}
              valueStyle={{ fontSize: 20 }}
            />
            <Progress
              percent={kpis.ignored_percent}
              showInfo={false}
              strokeColor="#d9d9d9"
              size="small"
            />
        ...
        <Col xs={24} sm={8}>
          <Card loading={loading}>
            <Statistic
              ...
              suffix={<Text type="secondary">({kpis.auto_categorized_percent.toFixed(1)}%)</Text>}
              prefix={<CheckCircleOutlined />}
            />
            <Progress
              percent={kpis.auto_categorized_percent}
              showInfo={false}
              strokeColor="#52c41a"
            />
          </Card>
        ...
        <Col xs={24} sm={8}>
          <Card loading={loading}>
            <Statistic
              ...
              suffix={<Text type="secondary">({kpis.regular_payments_percent.toFixed(1)}%)</Text>}
              prefix={<SyncOutlined />}
            />
            <Progress
              percent={kpis.regular_payments_percent}
              showInfo={false}
              strokeColor="#1890ff"
            />
          </Card>
