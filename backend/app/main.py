...
log_info(
    ...
    f"{settings.RATE_LIMIT_REQUESTS_PER_HOUR} req/hour per IP",
    "Startup"
)
...
async def health_check_api():
    """Health check endpoint (with API prefix for frontend)"""
    return {"status": "healthy"}
