...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('stream_type', postgresql.ENUM('REGIONAL', 'CHANNEL', 'PRODUCT', name='revenuestreamtypeenum', create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('name', sa.String(length=255), nullable=False),
        sa.Column('code', sa.String(length=50), nullable=True),
        sa.Column('category_type', postgresql.ENUM('PRODUCT', 'SERVICE', 'EQUIPMENT', 'TENDER', name='revenuecategorytypeenum', create_type=False), nullable=False),
        sa.Column('parent_id', sa.Integer(), nullable=True),
        sa.Column('department_id', sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('department_id', sa.Integer(), nullable=False),
        sa.Column('status', postgresql.ENUM('DRAFT', 'PENDING_APPROVAL', 'APPROVED', 'ACTIVE', 'ARCHIVED', name='revenueplanstatusenum', create_type=False), nullable=False, server_default='DRAFT'),
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('DRAFT', 'IN_REVIEW', 'REVISION_REQUESTED', 'APPROVED', 'REJECTED', 'ARCHIVED', name='revenueversionstatusenum', create_type=False), nullable=False, server_default='DRAFT'),
        sa.Column('description', sa.Text(), nullable=True),
        sa.Column('created_by', sa.Integer(), nullable=False),
        sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
        sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
