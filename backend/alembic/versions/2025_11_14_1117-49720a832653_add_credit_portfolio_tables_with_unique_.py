...
def upgrade() -> None:
    ...
    op.drop_index('idx_receipts_amount', table_name='receipts')
    op.drop_index('idx_receipts_bank_account_id', table_name='receipts')
    op.drop_index('idx_receipts_contract_date', table_name='receipts', postgresql_where='(contract_id IS NOT NULL)')
    op.drop_index('idx_receipts_contract_id', table_name='receipts')
    op.drop_index('idx_receipts_created_at', table_name='receipts')
    op.drop_index('idx_receipts_document_date', table_name='receipts')
    op.drop_index('idx_receipts_operation_id', table_name='receipts')
    op.drop_index('idx_receipts_org_amount', table_name='receipts', postgresql_where='((organization_id IS NOT NULL) AND (amount > (0)::numeric))')
    op.drop_index('idx_receipts_org_date', table_name='receipts', postgresql_where='(organization_id IS NOT NULL)')
    op.drop_index('idx_receipts_organization_id', table_name='receipts')
    op.drop_index('idx_receipts_payer', table_name='receipts')
    op.drop_index('idx_receipts_payment_purpose_gin', table_name='receipts', postgresql_using='gin')
    op.drop_table('receipts')
    op.drop_index('idx_contracts_active', table_name='contracts', postgresql_where='(is_active = true)')
    op.drop_index('idx_contracts_counterparty', table_name='contracts', postgresql_where='(counterparty IS NOT NULL)')
    op.drop_index('idx_contracts_organization_id', table_name='contracts')
    ...
    op.drop_index('idx_bank_accounts_active', table_name='bank_accounts', postgresql_where='(is_active = true)')
    op.drop_index('idx_bank_accounts_organization_id', table_name='bank_accounts')
    op.drop_index('ix_bank_accounts_account_number', table_name='bank_accounts')
    op.drop_table('bank_accounts')
    op.drop_table('schema_migrations')
    op.drop_index('idx_import_logs_failed', table_name='import_logs', postgresql_where="((status)::text = 'failed'::text)")
    op.drop_index('idx_import_logs_import_date', table_name='import_logs')
    op.drop_index('idx_import_logs_source_file', table_name='import_logs')
    op.drop_index('idx_import_logs_status', table_name='import_logs')
    op.drop_index('idx_import_logs_table_name', table_name='import_logs')
    op.drop_index('idx_import_logs_table_status', table_name='import_logs')
    op.drop_table('import_logs')
    op.drop_index('idx_expense_details_contract', table_name='expense_details')
    op.drop_index('idx_expense_details_expense_id', table_name='expense_details')
    op.drop_index('idx_expense_details_payment_type', table_name='expense_details')
    op.drop_index('idx_expense_details_settlement_account', table_name='expense_details')
    op.drop_index('idx_expense_details_unique', table_name='expense_details')
    op.drop_table('expense_details')
    op.drop_index('idx_organizations_active', table_name='organizations', postgresql_where='(is_active = true)')
