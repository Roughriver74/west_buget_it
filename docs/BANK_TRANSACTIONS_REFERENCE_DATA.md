...
ВФармСБ, ВгруппРосбанк, ВгруппСБ, Демо_Бонус, ДемоАльфа, ДемоВТБ, ДемоВТБ_Спец,
ДемоВТБ_спец, ДемоРосбанк, ДемоСБ, ДемоСБ_СП, ДемоСБ_Спец, ДемоСБ_спец, ДемоТБанк,
ДемоТбанк, Логистика_СП, МирумедВТБ, МирумедСБ, МирумедСБ_Спец, МирумедСБ_спец,
...
CREATE TABLE bank_accounts (
    ...
    name VARCHAR(100) NOT NULL UNIQUE,  -- "ДемоСБ"
    organization VARCHAR(100),           -- "Демо Групп"
...
class BankTransaction(Base):
    account_type = Column(String(100), nullable=True, index=True)  # "ДемоСБ", "МирумедВТБ"
